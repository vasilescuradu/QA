...
Acest document descrie funcționalitatea scriptului `script_cerinta_2.py`, creat pentru a interacționa automatizat cu aplicația Magazin Play (Google Play Store).
...
## Dependențe de Limbă (Localizare)
...
* **Sugestii AI pentru Selectoare:** Am folosit asistență AI pentru anumite sugestii de localizare (locators). De exemplu, la rezultatele căutării, îmi apărea și jocul *Hill Climb Racing 2*. Pentru a găsi o modalitate de a-l evita, am creat o regulă specifică: am căutat un element care începe cu „Hill Climb Racing” și **nu conține** cifra „2”.