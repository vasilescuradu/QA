...
- In folder-ul "Script_calculator" se afla un script ce realizeaza un calcul cu aplicatia Calculator.
- In folder-ul "Script_instalare_joc" se afla un script ce deschide Magazin Play si cauta jocul Hill Climb Racing, pe care 
